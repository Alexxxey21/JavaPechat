...
class BoxExx {
    ...
    private double depth;
        ...
        BoxExx(BoxExx ob) { // передать объект конструктору
            width = ob.width;
            height = ob.height;
            depth = ob.depth;
        }
        ...
        BoxExx (double w, double h, double d) {
            width = w;
            height = h;
            depth = d;
        }
    ...
    class BoxWeight2 extends BoxExx {
        ...
        // Конструтор применяемый при указании всех параметров
